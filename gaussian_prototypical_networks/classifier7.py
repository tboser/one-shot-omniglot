...
from gaussian_prototypical_networks.utils.loading import loadOmniglot
from gaussian_prototypical_networks.utils.dataprep import partitionByClass, prepareBatch, invert_img, deinvert_img, resize_img, subtract_mean, augment_by_rotations
from gaussian_prototypical_networks.utils.cnn6 import getPrototypes, getDistances, computeLoss, runModel, encoder_cnn_noaffine
...
def gpn_evaluate():
    ...
    labels_train, images_train, info_train, labels_val, images_val, info_val = loadOmniglot(
        path = "/Users/thomasboser/Desktop/ml-learning/fellowship-ai-challenge/gaussian_prototypical_networks/data/",train = 1, limit = 400
    )
